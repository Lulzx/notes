...
function pageContainerClassName(overlay, obstructed) {
  return `page-container ${overlay ? "page-container-overlay" : ""} ${
...
const StackedPageWrapper = ({
  ...
  <PageIndexProvider value={i}>
    <div
      className={pageContainerClassName(overlay, obstructed)}
