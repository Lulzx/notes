...
function TippyGenerator(tippy) {
  function Tippy(_ref) {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, children ? cloneElement(children, {
      ref: function ref(node) {
        mutableBox.ref = node;
        preserveRef(children.ref, node);
      }
    }) : null, mounted && createPortal(render ? render(toDataAttributes(attrs), singletonContent) : content, mutableBox.container));
  }
...
var forwardRef = (function (Tippy, defaultProps) {
  return forwardRef$1(function TippyWrapper(_ref, _ref2) {
    var children = _ref.children,
    ...
    return (
      ...
      // some reason
      React.createElement(Tippy, Object.assign({}, defaultProps, {}, props), children ? cloneElement(children, {
        ref: function ref(node) {
