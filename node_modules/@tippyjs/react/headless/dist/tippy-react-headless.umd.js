(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tippy.js/headless'), require('react'), require('prop-types'), require('react-dom')) :
  typeof define === 'function' && define.amd ? define(['exports', 'tippy.js/headless', 'react', 'prop-types', 'react-dom'], factory) :
  ...
  function TippyGenerator(tippy) {
    function Tippy(_ref) {
      ...
      return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, children ? React.cloneElement(children, {
        ref: function ref(node) {
          mutableBox.ref = node;
          preserveRef(children.ref, node);
        }
      }) : null, mounted && reactDom.createPortal(render ? render(toDataAttributes(attrs), singletonContent) : content, mutableBox.container));
    }
  ...
  var forwardRef = (function (Tippy, defaultProps) {
    return React.forwardRef(function TippyWrapper(_ref, _ref2) {
      var children = _ref.children,
      ...
      return (
        ...
        // some reason
        React__default.createElement(Tippy, Object.assign({}, defaultProps, {}, props), children ? React.cloneElement(children, {
          ref: function ref(node) {
