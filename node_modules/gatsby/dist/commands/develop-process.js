...
async function startServer(program) {
  ...
  const refresh = async req => {
    (0, _schemaHotReloader.stopSchemaHotReloader)();
    ...
    activity.end();
    activity = _reporter.default.activityTimer(`rebuild schema`);
    activity.start();
    await (0, _schema.rebuild)({
      parentSpan: activity
    });
    activity.end();
    (0, _schemaHotReloader.startSchemaHotReloader)();
  };
...
module.exports = async program => {
  ...
  compiler.hooks.done.tapAsync(`print gatsby instructions`, function (stats, done) {
    ...
    const urls = prepareUrls(program.https ? `https` : `http`, program.host, program.proxyPort);
